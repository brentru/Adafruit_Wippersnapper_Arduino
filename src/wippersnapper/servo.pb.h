...
#ifndef PB_WIPPERSNAPPER_SERVO_WIPPERSNAPPER_SERVO_PB_H_INCLUDED
#define PB_WIPPERSNAPPER_SERVO_WIPPERSNAPPER_SERVO_PB_H_INCLUDED
#include <pb.h>
...
#define WIPPERSNAPPER_SERVO_WIPPERSNAPPER_SERVO_PB_H_MAX_SIZE wippersnapper_servo_ServoAdd_size

...
#ifndef PB_WIPPERSNAPPER_UART_WIPPERSNAPPER_UART_PB_H_INCLUDED
#define PB_WIPPERSNAPPER_UART_WIPPERSNAPPER_UART_PB_H_INCLUDED
#include <pb.h>
...
#define WIPPERSNAPPER_UART_WIPPERSNAPPER_UART_PB_H_MAX_SIZE wippersnapper_uart_UARTBusData_size

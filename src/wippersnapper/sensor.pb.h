...
#ifndef PB_WIPPERSNAPPER_SENSOR_WIPPERSNAPPER_SENSOR_PB_H_INCLUDED
#define PB_WIPPERSNAPPER_SENSOR_WIPPERSNAPPER_SENSOR_PB_H_INCLUDED
#include <pb.h>
...
typedef struct _wippersnapper_sensor_SensorProperties {
    wippersnapper_sensor_SensorType sensor_type; /* * The sensor's type. */
    uint32_t sensor_period; /* * The sensor's period, in milliseconds. */
} wippersnapper_sensor_SensorProperties;
...
#define _wippersnapper_sensor_SensorType_MAX wippersnapper_sensor_SensorType_SENSOR_TYPE_BYTES
#define _wippersnapper_sensor_SensorType_ARRAYSIZE ((wippersnapper_sensor_SensorType)(wippersnapper_sensor_SensorType_SENSOR_TYPE_BYTES+1))

#define wippersnapper_sensor_SensorProperties_sensor_type_ENUMTYPE wippersnapper_sensor_SensorType
...
#define wippersnapper_sensor_SensorProperties_init_default {_wippersnapper_sensor_SensorType_MIN, 0}
...
#define wippersnapper_sensor_SensorProperties_init_zero {_wippersnapper_sensor_SensorType_MIN, 0}
...
#define wippersnapper_sensor_SensorProperties_sensor_type_tag 1
#define wippersnapper_sensor_SensorProperties_sensor_period_tag 2
...
#define wippersnapper_sensor_SensorProperties_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UENUM,    sensor_type,       1) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_period,     2)
#define wippersnapper_sensor_SensorProperties_CALLBACK NULL
#define wippersnapper_sensor_SensorProperties_DEFAULT NULL
...
extern const pb_msgdesc_t wippersnapper_sensor_SensorProperties_msg;
...
#define wippersnapper_sensor_SensorProperties_fields &wippersnapper_sensor_SensorProperties_msg
...
#define WIPPERSNAPPER_SENSOR_WIPPERSNAPPER_SENSOR_PB_H_MAX_SIZE wippersnapper_sensor_SensorEvent_SensorEventColor_size
...
#define wippersnapper_sensor_SensorProperties_size 8

...
#ifndef PB_WIPPERSNAPPER_ERROR_WIPPERSNAPPER_ERROR_PB_H_INCLUDED
#define PB_WIPPERSNAPPER_ERROR_WIPPERSNAPPER_ERROR_PB_H_INCLUDED
#include <pb.h>
...
#define WIPPERSNAPPER_ERROR_WIPPERSNAPPER_ERROR_PB_H_MAX_SIZE wippersnapper_error_Error_size

...
#ifndef PB_WIPPERSNAPPER_PWM_WIPPERSNAPPER_PWM_PB_H_INCLUDED
#define PB_WIPPERSNAPPER_PWM_WIPPERSNAPPER_PWM_PB_H_INCLUDED
#include <pb.h>
...
#define WIPPERSNAPPER_PWM_WIPPERSNAPPER_PWM_PB_H_MAX_SIZE wippersnapper_pwm_PWMWriteDutyCycleMulti_size

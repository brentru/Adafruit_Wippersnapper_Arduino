...
typedef enum _wippersnapper_analogio_AnalogIOAdd_AnalogReadMode {
    wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_ANALOG_READ_MODE_UNSPECIFIED = 0, /* Default value. */
    wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_ANALOG_READ_MODE_PIN_VALUE = 1, /* Raw ADC reading. */
    wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_ANALOG_READ_MODE_PIN_VOLTAGE = 2 /* Calculated voltage reading. */
} wippersnapper_analogio_AnalogIOAdd_AnalogReadMode;
...
typedef struct _wippersnapper_analogio_AnalogIOAdd {
    ...
    wippersnapper_analogio_AnalogIOAdd_AnalogReadMode read_mode; /* Type of value read by an analog pin. */
...
#define _wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_MIN wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_ANALOG_READ_MODE_UNSPECIFIED
#define _wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_MAX wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_ANALOG_READ_MODE_PIN_VOLTAGE
#define _wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_ARRAYSIZE ((wippersnapper_analogio_AnalogIOAdd_AnalogReadMode)(wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_ANALOG_READ_MODE_PIN_VOLTAGE+1))

#define wippersnapper_analogio_AnalogIOAdd_read_mode_ENUMTYPE wippersnapper_analogio_AnalogIOAdd_AnalogReadMode




/* Initializer values for message structs */
#define wippersnapper_analogio_AnalogIOAdd_init_default {0, 0, _wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_MIN}
...
#define wippersnapper_analogio_AnalogIOAdd_init_zero {0, 0, _wippersnapper_analogio_AnalogIOAdd_AnalogReadMode_MIN}

...
bool DigitalIOHardware::ConfigurePin(uint8_t name,
  ...
  switch (direction) {
  case esmp_v1_gpio_GPIODirection_GPIO_DIRECTION_OUTPUT:
...
#endif
    break;
  case esmp_v1_gpio_GPIODirection_GPIO_DIRECTION_INPUT:
    pinMode(name, INPUT);
    break;
  case esmp_v1_gpio_GPIODirection_GPIO_DIRECTION_INPUT_PULL_UP:
...
*/
bool DigitalIOHardware::GetValue(uint8_t pin_name) { return digitalRead(pin_name); }
